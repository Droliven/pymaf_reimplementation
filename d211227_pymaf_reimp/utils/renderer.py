...
from ..nets.smpl import get_smpl_faces
from .densepose_methods import DensePoseMethods
...
class IUV_Renderer(object):
    def __init__(self, focal_length=5000., orig_size=224, output_size=56, UV_data_path=""):

        self.focal_length = focal_length
        self.orig_size = orig_size

        DP = DensePoseMethods(UV_data_path)
        ...
        self.renderer = nr.Renderer(camera_mode='projection', image_size=output_size, fill_back=False,
                                    anti_aliasing=False,
