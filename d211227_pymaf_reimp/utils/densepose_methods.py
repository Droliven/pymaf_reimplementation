...
'''
@project : pymaf_reimp
@file    : densepose_methods.py
@author  : Levon
@contact : levondang@163.com
@ide     : PyCharm
@time    : 2021-12-27 21:15
'''
...
class DensePoseMethods:
    def __init__(self, UV_data_path=""):
        #
        ALP_UV = loadmat(os.path.join(UV_data_path, 'UV_Processed.mat'))
        ...
        self.Index_Symmetry_List = [1, 2, 4, 3, 6, 5, 8, 7, 10, 9, 12, 11, 14, 13, 16, 15, 18, 17, 20, 19, 22, 21, 24,
                                    23];
        UV_symmetry_filename = os.path.join(UV_data_path, 'UV_symmetry_transforms.mat')
