...
'''
@project : pymaf_reimp
@file    : maf_extractor.py
@author  : Levon
@contact : levondang@163.com
@ide     : PyCharm
@time    : 2021-12-27 16:24
'''
...
class MAF_Extractor(nn.Module):
    ...
    def __init__(self, device, data_dir=r"F:\model_report_data\three_dimension_reconstruction\spin_pymaf_data", MLP_DIM=[256, 128, 64, 5]):
