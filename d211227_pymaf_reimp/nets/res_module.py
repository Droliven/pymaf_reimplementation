...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1, BN_MOMENTUM=0.1):
...
#
#     def __init__(self, resnet_nums, in_channels=3, num_classes=229, last_stride=2, n_extra_feat=0, truncate=0, BN_MOMENTUM=0.1, **kwargs):
...
#         else:
#             print.error('=> imagenet pretrained model dose not exist')
#             print.error('=> please download it first')
#             raise ValueError('imagenet pretrained model does not exist')


class LimbResLayers(nn.Module):

    def __init__(self, resnet_nums, inplanes, outplanes=None, groups=1, BN_MOMENTUM=0.1, **kwargs):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, groups=1):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                ...
                nn.BatchNorm2d(planes * block.expansion * groups, momentum=self.BN_MOMENTUM),
            )
